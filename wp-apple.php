...
function WPapple_WidgetControl()
{
	...
	// retireve ppw title from the request
      ...
      //  $options['apple_fourth_name']  = strip_tags(stripslashes($_POST["apple_fourth_name"]));
        $options['apple_radio_widesidebar']   = strip_tags(stripslashes($_POST["apple_widesidebar"]));
        $options['apple_radio_smallsidebar']  = strip_tags(stripslashes($_POST["apple_smallsidebar"]));
	...
	$apple_second_name = $options['apple_second_name'];
     ...
     //   $apple_fourth_name  = $options['apple_fourth_name'];

        $apple_smallsidebar = $options['apple_smallsidebar'];
        $apple_widesidebar = $options['apple_widesidebar'];
